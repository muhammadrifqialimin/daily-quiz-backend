...
- **Secure Database:** Menggunakan MySQL dengan proteksi _Mass Assignment_.
...
1.  **Clone Repository**
    ...
    ```bash
    git clone [https://github.com/muhammadrifqialimin/daily-quiz-app.git](https://github.com/muhammadrifqialimin/daily-quiz-app.git)
    cd daily-quiz-app
    ```
